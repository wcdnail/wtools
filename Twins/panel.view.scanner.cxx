                ...
                InProgress = true;
                {
                    ...
                    try {
                        ...
                        if (IsError = FAILED(err.Hr)) {
                            DH::TPrintf(0, L"SCANNER: '%s' ERROR - 0x%08x %s\n", path.c_str(), err.Hr, err.Message);
                        }
                        else {
                            ParseBuffer();
                        }
