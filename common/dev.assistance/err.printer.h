...
{
    HRESULT const            hr{static_cast<HRESULT>(GetLastError())};
    ATL::CStringW const     msg{Str::ErrorCode<wchar_t>::SystemMessage(hr)};
    ATL::CW2AEX<512> const conv{msg.GetString(), CP_UTF8};
...
{
    winrt::hstring const    msg{ex.message()};
    ATL::CW2AEX<512> const conv{msg.c_str(), 1251};
