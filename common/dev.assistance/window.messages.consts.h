...
// 
  ...
  //_ON_CONST(LVM_SETUNICODEFORMAT          ); // CCM_SETUNICODEFORMAT
    ...
    _ON_CONST(OCM_COMMAND          );

#ifdef _WIN32
    _ON_CONST(OCM_CTLCOLORBTN      );
    _ON_CONST(OCM_CTLCOLOREDIT     );
    _ON_CONST(OCM_CTLCOLORDLG      );
    _ON_CONST(OCM_CTLCOLORLISTBOX  );
    _ON_CONST(OCM_CTLCOLORMSGBOX   );
    _ON_CONST(OCM_CTLCOLORSCROLLBAR);
    _ON_CONST(OCM_CTLCOLORSTATIC   );
#else
    _ON_CONST(OCM_CTLCOLOR         );
#endif

    _ON_CONST(OCM_DRAWITEM         );
    _ON_CONST(OCM_MEASUREITEM      );
    _ON_CONST(OCM_DELETEITEM       );
    _ON_CONST(OCM_VKEYTOITEM       );
    _ON_CONST(OCM_CHARTOITEM       );
    _ON_CONST(OCM_COMPAREITEM      );
    _ON_CONST(OCM_HSCROLL          );
    _ON_CONST(OCM_VSCROLL          );
    _ON_CONST(OCM_PARENTNOTIFY     );

#if (WINVER >= 0x0400)
    _ON_CONST(OCM_NOTIFY           );
#endif

    _ON_CONST(WM_UAHDESTROYWINDOW   );
    _ON_CONST(WM_UAHDRAWMENU        );
    _ON_CONST(WM_UAHDRAWMENUITEM    );
    _ON_CONST(WM_UAHINITMENU        );
    _ON_CONST(WM_UAHMEASUREMENUITEM );
    _ON_CONST(WM_UAHNCPAINTMENUPOPUP);
