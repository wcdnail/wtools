...
#pragma region Tracers
    ...
    template <typename CharType>
                struct TTTraits {};
    template <> struct TTTraits<char>    { static inline const  PCSTR Header =  "%0*.8f|[%06d]|"; static inline const  PCSTR Category =  "%12s| "; };
    template <> struct TTTraits<wchar_t> { static inline const PCWSTR Header = L"%0*.8f|[%06d]|"; static inline const PCWSTR Category = L"%12s| "; };
