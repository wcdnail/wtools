...
void CFileView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	pWndTree->SetFocus();
	_App.GetContextMenuManager()->ShowPopupMenu(IDR_POPUP_EXPLORER, point.x, point.y, this, TRUE);
}
...
void CFileView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(_App.m_bHiColorIcons ? IDB_EXPLORER_24 : IDR_EXPLORER, 0, 0, TRUE /* Заблокирован */);

	m_FileViewImages.DeleteImageList();

	UINT uiBmpId = _App.m_bHiColorIcons ? IDB_FILE_VIEW_24 : IDB_FILE_VIEW;
	...
	nFlags |= (_App.m_bHiColorIcons) ? ILC_COLOR24 : ILC_COLOR4;
