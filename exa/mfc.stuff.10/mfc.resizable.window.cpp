...
CString CWndResizer::CPanel::ToString()
{
  ...
  CString sTo;
  sTo.Format(sFormat, Name, GetTypeName(), Anchor, Width(), Height(),
      left, top, right, bottom,
      MinSize.cx, MinSize.cy, MaxSize.cx, MaxSize.cy, 
      (Parent == NULL ? _T("NULL") : Parent->Name.GetString()), 
      Children.GetCount()
  );
  return sTo;
}
