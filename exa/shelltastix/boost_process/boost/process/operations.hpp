...
{ 
    ...
    if (result.empty()) 
    {
        boost::filesystem::filesystem_error ex("boost::process::find_executable_in_path: file not found", 
            file, boost::system::errc::make_error_code(boost::system::errc::no_such_file_or_directory));
