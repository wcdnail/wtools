...
public:
   ...
   ATL::CString m_sToolTipText; // ToolTip text
   WTL::CToolTipCtrl m_tip;     // ToolTip control
   WTL::CBrush m_brBack;        // Brush background (when FSTBS_CAPTUREBKG is active)
   WTL::CBitmapHandle m_bitmap; // Bitmap containing button graphics (all states)
