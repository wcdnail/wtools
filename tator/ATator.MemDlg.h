                      ...
                      WTL::CMessageFilter
{
    enum Sizes: short
    {
        DIALOG_CX = CColorPicker::HOST_DLG_CX + 90,
        DIALOG_CY = CColorPicker::HOST_DLG_CY + 80,
    };
    ...
    BEGIN_CONTROLS_MAP()
        ...
        CONTROL_CONTROL(_T(""), IDC_CUSTOM_CTL1, _T("WCCF::CColorPicker"), 0, 14, 14, DIALOG_CX-28, DIALOG_CY-54, WS_EX_CONTROLPARENT)
